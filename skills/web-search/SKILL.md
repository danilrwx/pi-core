...
```bash
{baseDir}/search.ts "your search query"
```
...
```bash
# Basic search
{baseDir}/search.ts "python async await tutorial"

# Search for recent news
{baseDir}/search.ts "latest AI developments 2024"

# Find documentation
{baseDir}/search.ts "nodejs fs promises API"
```
